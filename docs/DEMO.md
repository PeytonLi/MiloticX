...
| **1:30–1:50** | **THE PAUSE.** The UI shows the **Approval required** gate: the tool name, the arguments, and Approve / Deny. Leave it on screen. This is the moment the hackathon says nobody films. | Control & safety |
